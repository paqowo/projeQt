...
export const CARDS: Card[] = [
  ...
  },
  {
    ...
    body: 'Schopnost vyladění se na pocity srdce. Vcítění naslouchá emocím. Učíme se rozlišovat, co je pro nás příjemné a nepříjemné. Sounáležitost harmonizuje myšlenkové pochody mezi myslí a srdcem. Vyrovnáním nacházíme napojení, pocity, sny a vize. Objasňující vše, co je pro vás důležité.',
    shadow: 'Stín: Blok mezi myslí a srdcem, neschopnost vcítění a jemnosti.',
